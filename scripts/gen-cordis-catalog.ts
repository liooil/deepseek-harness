...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  dshRuntimePaths: 'not a service: packaged-host filesystem resource resolver (DshRuntimePaths | undefined) — packages/boot/app-boot/README.md owns the boot contract',
